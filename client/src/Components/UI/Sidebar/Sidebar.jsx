        ...
        <div className="sidebar">
            <div className="sidebar_container">
                <div className="sidebar_containerTop">
                    <Link to="/dashboard" className="sidebar_containerTitle">vitatri's<span>board</span></Link>
                    <div className="sidebar_containerMenu">
                        <Link to="/dashboard" className="sidebar_containerMenu_item">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M240-200h120v-240h240v240h120v-360L480-740 240-560v360Zm-80 80v-480l320-240 320 240v480H520v-240h-80v240H160Zm320-350Z" /></svg>
                            Inicio
                        </Link>
                        <Link to="/dashboard/profile" className="sidebar_containerMenu_item">
                ...
                <div className="sidebar_containerBottom">
                    <Link to="/logout" className="sidebar_containerLogout">
